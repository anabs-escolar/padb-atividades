...
explain analyze
select first_name from customer where email = 'a@tads.ifrn';
...
select id, to_tsvector('portuguese', title || ' ' || body) body_seach from posts;
